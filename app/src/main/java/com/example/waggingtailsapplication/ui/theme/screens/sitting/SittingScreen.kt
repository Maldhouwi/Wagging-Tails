package com.example.waggingtailsapplication.ui.theme.screens.sitting
...
@Composable
fun SittingScreen(navController: NavHostController){
                ...
                .verticalScroll(rememberScrollState()))
        {
                    ...
                    .fillMaxWidth())
            {
                ...
                Column {
                   ...
                   Row {
                    ...
                    Text(
                        text = "Experienced Handler",
                        fontSize = 20.sp,
                    )
                    Spacer(modifier = Modifier.height(5.dp))

                    Text(
                        text = "Available On Weekdays",
                        fontSize = 15.sp,
                    )
                    Spacer(modifier = Modifier.height(5.dp))
                    ...
                    .fillMaxWidth())
            {
                ...
                Column {
                    ...
                    Text(
                        text = "Available From Wed to Fri",
                        fontSize = 15.sp,
                    )
                    Spacer(modifier = Modifier.height(5.dp))
                    ...
                    .fillMaxWidth())
            {
                ...
                Column {
                    ...
                    Text(
                        text = "Located along Waiyaki Way",
                        fontSize = 15.sp,
                    )
                    Spacer(modifier = Modifier.height(5.dp))
...
@Composable
fun SittingScreenPreview(){
    SittingScreen(rememberNavController())
}